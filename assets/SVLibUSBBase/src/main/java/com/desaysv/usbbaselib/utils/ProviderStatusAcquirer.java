 ...
 * Comment Provider状态获取的工具
 */
public class ProviderStatusAcquirer {

    private static final String TAG = "ProviderStatusAcquirer";

    public static final int USB_STATUS_SCAN_STARTED = 2;

    public static final int USB_STATUS_SCAN_FINISHED = 4;

    public static final int USB_STATUS_SCAN_IDLE = -1;
    ...
    private static ProviderStatusAcquirer instance;

    private ContentResolver mContentResolver;

    public static ProviderStatusAcquirer getInstance() {
        if (instance == null) {
            synchronized (ProviderStatusAcquirer.class) {
                if (instance == null) {
                    instance = new ProviderStatusAcquirer();
                }
            }
        }
        return instance;
    ...
    private ProviderStatusAcquirer() {
