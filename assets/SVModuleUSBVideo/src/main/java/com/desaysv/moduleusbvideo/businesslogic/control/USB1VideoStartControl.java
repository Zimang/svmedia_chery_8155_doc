 ...
 * Comment USB1视频的启动器，用来启动USB视频
 * @author uidp5370
 */
public class USB1VideoStartControl extends BaseVideoStartControl {

    private static final String TAG = "USB1VideoStartControl";

    private static final class InstanceHolder {
        static final USB1VideoStartControl instance = new USB1VideoStartControl();
    }

    public static USB1VideoStartControl getInstance() {
        return InstanceHolder.instance;
    }

    private USB1VideoStartControl() {
    ...
    protected void startView() {
        USB1VideoPlayActivity.startUSB1VideoPlayActivity(AppBase.mContext, ModuleUSBVideoTrigger.getInstance().USB1VideoStatusTool.getCurrentPlayItem().getPath());
    }
    ...
    protected boolean isEnableOpen() {
        ...
        return SearchType.SEARCHED_HAVE_DATA == videoSearchType || SearchType.SEARCHING_HAVE_DATA == videoSearchType;
    }
}
