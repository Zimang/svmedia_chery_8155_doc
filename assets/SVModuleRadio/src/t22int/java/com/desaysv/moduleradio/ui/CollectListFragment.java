...
public class CollectListFragment extends RadioBaseListFragment implements RadioCollectListAdapter.OnItemClickListener {
    ...
    public int getLayoutResID() {
        ...
        return hasMulti ? R.layout.radio_fragment_collect_multi : ProductUtils.isRightRudder() ? R.layout.radio_fragment_collect_right: R.layout.radio_fragment_collect;
    }
    ...
    void updateCollectListFragment() {
        ...
        if (hasMulti){
            ...
            //不需要再区分是否带AM，MultiCollectRadioMessageList里面会添加全部
            //25/02/20修改，MultiCollectRadioMessageList里面去掉AMCollectList
            if (hasAM){
