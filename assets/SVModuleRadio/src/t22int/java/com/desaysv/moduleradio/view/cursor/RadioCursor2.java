...
public class RadioCursor2 extends LinearLayout {
    private static final String TAG = "RadioCursor2";

    OnFrequencyChangedListener onFrequencyChangedListener;

    HorizontalCursorView2 fmCursorView;
    HorizontalCursorView2 amCursorView;

    CursorAdapter fmCursorAdapter, amCursorAdapter;

    private int band = RadioManager.BAND_FM;

    public RadioCursor2(@NonNull Context context) {
        super(context);
    }

    public RadioCursor2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RadioCursor2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    private void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.radio_cuesor2, this, false);
