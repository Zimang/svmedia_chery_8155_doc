...
public class CollectListFragment extends RadioBaseListFragment implements RadioCollectListAdapter.OnItemClickListener {
    ...
    public void initView(View view) {
        ...
        rvRadioCollectList.setItemAnimator(null);
    ...
    public void onItemClick(int position, RadioMessage radioMessage) {
        ...
        SPUtlis.getInstance().saveShowCollectListMode(true);
        if (radioMessage.getRadioType() == RadioMessage.DAB_TYPE){//当前点击的是 DAB
            if (mGetRadioStatusTool.getCurrentRadioMessage().getDabMessage() != null && radioMessage.getDabMessage().getServiceId() == mGetRadioStatusTool.getCurrentRadioMessage().getDabMessage().getServiceId()
    ...
    public void onResume() {
        super.onResume();
        CurrentShowFragmentUtil.isCollectPageOnResume = true;
    ...
    public void onPause() {
        super.onPause();
        CurrentShowFragmentUtil.isCollectPageOnResume = false;
    }
}
