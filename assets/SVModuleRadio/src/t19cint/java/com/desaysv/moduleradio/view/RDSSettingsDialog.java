...
public class RDSSettingsDialog extends Dialog implements View.OnClickListener, SettingSwitchView.OnCheckedChangeListener {
    ...
    private void init(Context context) {
        ...
        setContentView(isRightRudder ? R.layout.radio_rds_dialog_right: R.layout.radio_rds_dialog);
        ...
        tv_rds_rec = findViewById(R.id.tv_rds_rec);
    ...
    private void updateView(boolean isCheck) {
        ...
        if (isCheck) {
            ...
            tv_rds_rec.setEnabled(true);
            tv_rds_af.setEnabled(true);
            tv_rds_ta.setEnabled(true);
        } else {
            //关闭并置灰
            scRdsRec.setEnabled(false);
            scRdsAf.setEnabled(false);
            scRdsTa.setEnabled(false);
            tv_rds_rec.setEnabled(false);
            tv_rds_af.setEnabled(false);
            tv_rds_ta.setEnabled(false);
        }
    }
