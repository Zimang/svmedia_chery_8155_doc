...
public class RadioMainFragment extends BaseFragment implements RadioHomeFragment.IOnItemClickListener, RadioPlayFragment.IOnBackClickListener, DABPlayFragment.IOnBackClickListener,DABListMainFragment.IOnBackClickListener,DABEPGFragment.IOnBackClickListener {
    ...
    public void onDABListBackClick() {
        setTargetFragment(Constants.NavigationFlag.FLAG_DAB_PLAY);
    }
