...
public class AMCollectListFragment extends BaseFragment {
    ...
    public void initView(View view) {
        ...
        playListAdapter.setCollectList(true);
    ...
    public void initData() {
        if (RadioList.getInstance().getAMCollectRadioMessageList().size() < 1){
            ...
            playListAdapter.updateList(RadioList.getInstance().getAMCollectRadioMessageList());
        }
    }
    ...
    private static class MyHandler extends Handler {
        WeakReference<AMCollectListFragment> weakReference;

        MyHandler(AMCollectListFragment listFragment) {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            final AMCollectListFragment listFragment = weakReference.get();
            // 只有界面显示了，才进行接收数据
