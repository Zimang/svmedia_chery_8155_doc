 ...
 * Comment
 */
public class DsvMusicRemoteManager extends BaseRemoteManager {

    private static final String TAG = "DsvMusicRemoteManager";
     ...
     * 媒体端的AIDL binder
     */
    private IAIDLMediaManager mMusicAIDLManager;

    public static DsvMusicRemoteManager getInstance() {
        if (instance == null) {
            synchronized (DsvMusicRemoteManager.class) {
                if (instance == null) {
                    instance = new DsvMusicRemoteManager();
                }
            }
        }
        return instance;
    ...
    protected void setAidlMediaManager(IAIDLMediaManager iAidlMediaManager) {
        mMusicAIDLManager = iAidlMediaManager;
    }
    ...
    public static void open(Context context, String source, boolean isForeground, boolean isRequestFocus, String openReason) {
        ...
        intent.setPackage(PackageConfig.MUSIC_APP_PACKAGE);
