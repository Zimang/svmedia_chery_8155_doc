...
public class MediaInfoBean {
    ...
    public static class Builder {
        ...
        public Builder setConnectState(String connectState) {
            this.connectState = connectState;
            return this;
        }
        ...
        public Builder setOpenReason(String openReason) {
            this.openReason = openReason;
            return this;
        }
        ...
        public MediaInfoBean created() {
            ...
            if (connectState != null) {
                mediaInfoBean.setConnectState(connectState);
            }
            if (seekToTime != null) {
            ...
            if (openReason != null) {
                mediaInfoBean.setOpenReason(openReason);
            }
            return mediaInfoBean;
        }
    }
