...
import com.desaysv.localmediasdk.sdk.bean.AudioSourceOriginBean;
import com.desaysv.localmediasdk.sdk.listener.IMediaControl;
...
public class MediaRemoteControl implements IMediaControl {
    ...
    public void seekTo(String source, int time) {
        ...
        if (mMediaFunctionMap.get(AudioSourceOriginBean.transformSource(source)) == null) {
            Log.w(TAG, "seekTo: remote control is null");
            return;
        }
        mMediaFunctionMap.get(AudioSourceOriginBean.transformSource(source)).seekTo(source, time);
    }
    ...
    public void changeLoopType(String source, String typeInfo) {
        ...
        mMediaFunctionMap.get(AudioSourceOriginBean.transformSource(source)).changeLoopType(source, typeInfo);
    }
    ...
    public String getDeviceConnectState(String source) {
        ...
        if (mMediaFunctionMap.get(AudioSourceOriginBean.transformSource(source)) == null) {
            Log.w(TAG, "getDeviceConnectState: remote control is null");
            return null;
        }
        String connectState = mMediaFunctionMap.get(AudioSourceOriginBean.transformSource(source)).getDeviceConnectState(source);
