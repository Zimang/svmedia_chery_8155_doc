...
public class CircularProgressView extends View {
    ...
    private int mProgress;      // 圆环进度(0-mMaxProgress)
    private int mMaxProgress = 1;      // 圆环最大进度值
     ...
     * 设置当前进度
     *
     * @param progress 当前进度（0-mMaxProgress）
     */
