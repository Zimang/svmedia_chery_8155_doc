...
//            mLoadingDialog.dismiss();
    ...
    public boolean handleShowAllPictures() {
        ...
        updateListAdapter(PictureListManager.getInstance().getAllUSB1PictureList(),null);
    ...
    public boolean handleShowFolderPictures() {
        ...
        if (MediaKey.SUPPORT_SUBSECTION_LOADING) {
            ...
            updateListAdapter(PictureListManager.getInstance().getUSB1RootPictureList(),PictureListManager.getInstance().getUSB1RootFolderList());
        }
        updateViewWithCurrentPath(USBConstants.USBPath.USB0_PATH);
        folderAdapter.setCurrentFolderPath(USBConstants.USBPath.USB0_PATH);
        ...
        if (PictureListManager.getInstance().getAllUSB1PictureList() != null){
            ...
            if (styleType == STYLE_TYPE_FOLDER) {
                if (MediaKey.SUPPORT_SUBSECTION_LOADING){
                    ...
                    updateListAdapter(PictureListManager.getInstance().getCurrentUSB1PictureList(), PictureListManager.getInstance().getCurrentUSB1FolderList());
