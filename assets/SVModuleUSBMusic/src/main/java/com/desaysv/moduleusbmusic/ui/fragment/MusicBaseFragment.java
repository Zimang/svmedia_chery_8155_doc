...
public abstract class MusicBaseFragment extends BaseFragment {
    ...
    private static class MediaHandler extends Handler {
        WeakReference<MusicBaseFragment> mWeakReference;

        private MediaHandler(MusicBaseFragment fragment) {
        ...
        public void handleMessage(Message msg) {
            ...
            MusicBaseFragment fragment = mWeakReference.get();
            if (fragment.isAdded()) {
                fragment.dispatchMessage(msg, fragment);
            } else {
                Log.w(fragment.TAG, "dispatchMessage: fragment is no add");
            }
        }
    }
     ...
     */
    protected abstract void dispatchMessage(Message msg, MusicBaseFragment fragment);
