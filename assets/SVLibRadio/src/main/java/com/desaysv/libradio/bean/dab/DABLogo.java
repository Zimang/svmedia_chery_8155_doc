...
/**
 * @author uidq4079
 * @desc 底层解析当前获取到的所有 DAB logo，应用做对应保存，显示时从对应列表取出
 * @time 2022-9-22 19:20
 */
public class DABLogo implements Parcelable, Serializable {
    ...
    public static final Creator<DABLogo> CREATOR = new Creator<DABLogo>() {
        @Override
        public DABLogo createFromParcel(Parcel in) {
            return new DABLogo(in);
        }

        @Override
        public DABLogo[] newArray(int size) {
            return new DABLogo[size];
        }
    };
