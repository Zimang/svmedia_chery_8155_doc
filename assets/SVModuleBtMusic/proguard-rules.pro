...
###############  platformadapter.jar ###########################
-keep class desaysv.** { *; }
-keep class dsv.platformadapter.** { *; }
-keep class com.desaysv.vehiclelan.proxy.** { *; }
-keep class com.desaysv.ivi.platformadapter.** { *; }
...
-keep class io.** { *; }
-keep class rx.** { *; }
-keep class com.codezjx.andlinker.** { *; }
-keep class com.desaysv.sdk.bluetooth.** { *; }
-keep class com.hp.hpl.sparta.** { *; }
-keep class com.pinyinsearch.** { *; }
-keep class net.sourceforge.pinyin4j.** { *; }
-keep class com.desaysv.libvr.** { *; }
-keep class me.everything.android.** { *; }
-keep class q.rorbin.** { *; }

############### 保持公共自定义控件 ###########################
-keep class com.desaysv.svlibtoast.**{ *; }
