...
public class SwitchButton extends CompoundButton {
    ...
    public static final float DEFAULT_THUMB_RANGE_RATIO = 2f;   //默认总体宽度与thumb的比例
    public static final int DEFAULT_THUMB_SIZE_DP = 20;
    public static final float DEFAULT_THUMB_SIZE_RADIUS_MINUS_DP = 2.8f;   //thumb半径在缩小时需要减去的大小
    public static final float DEFAULT_THUMB_MARGIN_DP = 3.8f;   //thumb外边距
    public static final int DEFAULT_ANIMATION_DURATION = 250;   //默认动画时常
    public static final int DEFAULT_TINT_COLOR = 0x327FC2;
    public static final float DEFAULT_DISABLED_ALPHA = 0.5f;    //默认不可用透明度
    ...
    private void init(AttributeSet attrs) {
        ...
        drawableIds = isRightRudder ?new int[]{R.mipmap.img_btn_0_right, R.mipmap.img_btn_1_right, R.mipmap.img_btn_2_right, R.mipmap.img_btn_3_right,
                R.mipmap.img_btn_4_right, R.mipmap.img_btn_5_right, R.mipmap.img_btn_6_right, R.mipmap.img_btn_7_right,
                R.mipmap.img_btn_8_right, R.mipmap.img_btn_9_right, R.mipmap.img_btn_10_right} : new int[]{R.mipmap.img_btn_0, R.mipmap.img_btn_1, R.mipmap.img_btn_2, R.mipmap.img_btn_3,
