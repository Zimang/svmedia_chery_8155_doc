...
public class QueryPictureTask extends BaseQueryTask{
    public QueryPictureTask(Context context, IQueryResultListener listener) {
        super(context, listener);
    }

    public QueryPictureTask(Context context, IQueryResultListener listener, String dir) {
        super(context, listener, dir);
    }

    public QueryPictureTask(Context context, IQueryResultListener listener, String dir, boolean forceUpdate) {
    ...
    protected void addUSB1CacheList() {
        Log.d(TAG,"addUSB1CacheList:"+directory);
