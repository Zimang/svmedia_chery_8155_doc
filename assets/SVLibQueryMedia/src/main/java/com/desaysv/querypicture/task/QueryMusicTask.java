...
public class QueryMusicTask extends BaseQueryTask{
    public QueryMusicTask(Context context, IQueryResultListener listener) {
        super(context, listener);
    }

    public QueryMusicTask(Context context, IQueryResultListener listener, String dir) {
        super(context, listener, dir);
    }

    public QueryMusicTask(Context context, IQueryResultListener listener, String dir, boolean forceUpdate) {
    ...
    protected FileMessage getAndroidMessage() {
        ...
        fileMessage.setDuration(mCursor.getString(mCursor.getColumnIndex(MediaStore.Audio.AudioColumns.DURATION)));
